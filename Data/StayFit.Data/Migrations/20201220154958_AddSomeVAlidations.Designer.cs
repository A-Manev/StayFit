...
namespace StayFit.Data.Migrations
{
    ...
    [Migration("20201220154958_AddSomeVAlidations")]
    partial class AddSomeVAlidations
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StayFit.Data.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<double>("RemainingCalories")
                        .HasColumnType("float");

                    b.Property<double>("RemainingCarbs")
                        .HasColumnType("float");

                    b.Property<double>("RemainingFat")
                        .HasColumnType("float");

                    b.Property<double>("RemainingProtein")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("StayFit.Data.Models.Like", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("StayFit.Data.Models.MealDiary", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<double>("MealQuantity")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("StayFit.Data.Models.Comment", b =>
                {
                    ...
                    b.HasOne("StayFit.Data.Models.Comment", "Parent")
                        .WithMany()
            ...
            modelBuilder.Entity("StayFit.Data.Models.Like", b =>
                {
                    b.HasOne("StayFit.Data.Models.Comment", "Comment")
                        .WithMany("Likes")
